  ...
  return (
    <main style={{ fontFamily:"system-ui,sans-serif", minHeight:"100vh", padding:"90px 20px 60px", position:"relative", zIndex:1 }}>
      <div style={{ maxWidth:800, margin:"0 auto" }}>
        ...
        <p style={{ color:"var(--sub)", fontSize:15, marginBottom:40 }}>Embed live Web3 & crypto news from Sanctifi3d Labs on your website for free.</p>

        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))", gap:32 }}>
          <div>
            <h2 style={{ fontWeight:800, fontSize:18, color:"var(--fg)", marginBottom:16 }}>Preview</h2>
            <iframe src="/widget" width="300" height="500" style={{ borderRadius:16, border:"1px solid var(--border)", width:"100%" }} />
          </div>
          <div>
            <h2 style={{ fontWeight:800, fontSize:18, color:"var(--fg)", marginBottom:16 }}>How to embed</h2>
            <p style={{ color:"var(--sub)", fontSize:14, marginBottom:16, lineHeight:1.7 }}>Copy and paste this code into any webpage, blog, or portfolio. It automatically shows the latest posts from Sanctifi3d Labs.</p>
